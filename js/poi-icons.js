(function() {
  ...
  const ICON_METADATA_OVERRIDES = Object.freeze({
    ...
    evil_temple: { traits: ["underground", "forbidden", "worship", "cultic"] },
    barrow: { traits: ["underground", "funerary", "ancient"] },
    abandoned_mine: { traits: ["underground", "mining", "abandoned"] },
    tomb: { traits: ["underground", "funerary", "sealed"] },
    buried_ruins: { traits: ["underground", "ancient", "ruined"] },
    vault: { traits: ["underground", "sealed", "hidden"] },
    sewer: { traits: ["underground", "urban", "hidden"] },
