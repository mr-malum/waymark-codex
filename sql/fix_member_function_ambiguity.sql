-- =========================================================
-- Waymark Codex
-- Fix duplicate add-member RPC overloads
-- =========================================================
--
-- Run this in Supabase SQL Editor if add-member reports:
-- "Could not choose the best candidate function..."

drop function if exists public.add_campaign_member_by_username(
  uuid,
  public.citext,
